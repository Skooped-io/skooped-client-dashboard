const agents = [
  ...
  { name: "Sierra", title: "Social Media", status: "Active", statusColor: "bg-success", gradient: "from-primary to-secondary", bio: "Sierra plans, creates, and schedules your Instagram and Facebook content. Your social presence stays active even when you're busy.", lastActive: "4 hours ago" },
